...
## סקר שוק
ביטויי חיפוש שהשתמשנו בהם עבור E.M.T - The First Responder : 
- Paramedic Simulator
- EMT Game
...
**קישור:** [Ambulance Life ב-Steam ](https://store.steampowered.com/app/1926520/Ambulance_Life_A_Paramedic_Simulator/)



**צילום מסך:**
![חובש 1](https://github.com/user-attachments/assets/e3e11e09-c14c-43ab-9754-671561103d38)


**איך המשחק שלי יהיה שונה/מיוחד:**
המשחק הזה מתמקד בעיקר בנהיגה באמבולנס ובפינוי חולים. המשחק שלי מדגיש את הטיפול בשטח עצמו—הרגעים הקריטיים לפני הפינוי, כשהחיים תלויים בהחלטות המהירות של החובש. אצלנו אין נהיגה, רק התמודדות ישירה עם הפצועים בזירה.
בנוסף , יהיה אצלנו יהיו זירות שמתאימות יותר למציאות הישראלית כגון זירות פיגוע , אר"ן (אירוע רב נפגעים) , פצעי ירי , צבא וכדומ


**הרכיב שמדגיש את הייחוד:**
תהליך הליבה—בחירת סדר פעולות נכון לטיפול בפצועים תחת לחץ, עם משאבים מוגבלים.

---
**2.** Full Code Medical Simulation

**קישור:** [Full Code Medical Simulation](https://fullcodemedical.com/)

**צילום מסך:**
![חובש 3](https://github.com/user-attachments/assets/28469529-9906-4984-bd1d-56ae590594b6)




**איך המשחק שלי יהיה שונה/מיוחד:**
Full Code הוא סימולציה קלינית שמתמקדת בבית חולים, במקרים רפואיים כלליים
 המשחק שלי ממוקד בחובש בשטח—מצבים לא סטריליים, בתנאים משתנים (כביש, שדה קרב, אזור מגורים), עם מגבלות זמן וציוד.
 הדגש הוא על קבלת החלטות תחת לחץ, כשאין צוות רפואי שלם מאחוריך.


**הרכיב שמדגיש את הייחוד**:
העימותים בין השחקן למערכת—הצורך להתמודד עם סביבות קשות, פצועים במצבים משתנים, וזמן שמתקתק.

---

**3.** Zero Hour: America's Medic

**קישור:** [Zero Hour: America’s Medic - ARA](https://www.ara.com/zero-hour-americas-medic/)

**צילום מסך:**![חובש4](https://github.com/user-attachments/assets/52791262-9ad4-4419-a086-8b4cede54e5d)

 

**איך המשחק שלי יהיה שונה/מיוחד:**
 Zero Hour מתמקד בניהול אירועים בקנה מידה גדול, עם הרבה נפגעים וצורך בתיאום בין גורמים שונים.
 המשחק שלי מתמקד בחובש יחיד בשטח, שפועל לבד בתנאים לא אידיאליים. אין צוותים מסביב ואין ניהול רחב—רק השחקן מול הפצועים, צריך להחליט במהירות איך לטפל ומתי.
 המיקוד הוא בעזרה ראשונה בשטח בזמן אמת ולא בניהול כולל של אירוע חירום.


**הרכיב שמדגיש את הייחוד:**
 החוקים והעימותים—המשחק שלי מייצר דילמות מיידיות של סדר עדיפויות, ציוד מוגבל, ולחץ זמן אישי, בלי מערכות ניהול מורכבות או צוותים נוספים.
